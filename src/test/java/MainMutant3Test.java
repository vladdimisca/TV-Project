...
class MainMutant3Test {
    ...
    @Test
    void equivalence() {
        assertArrayEquals(new String[]{messageNotValid}, MainMutant3.calculate(0, 1000, 1000));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant3.calculate(1000, 0, 1000));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant3.calculate(1000, 1000, 0));
        assertArrayEquals(
                new String[]{String.format(messageCoPrime, 15, 17), String.format(messageSumIsGreater, 15, 17, 11)},
                MainMutant3.calculate(15, 17, 11));
        assertArrayEquals(
                new String[]{String.format(messageNotCoPrime, 14, 18), String.format(messageSumIsGreater, 14, 18, 11)},
                MainMutant3.calculate(14, 18, 11));
        assertArrayEquals(
                new String[]{String.format(messageCoPrime, 12, 11), String.format(messageSumIsNotGreater, 12, 11, 11)},
                MainMutant3.calculate(12, 11, 11));
        assertArrayEquals(
                new String[]{String.format(messageNotCoPrime, 14, 12), String.format(messageSumIsNotGreater, 14, 12, 11)},
                MainMutant3.calculate(14, 12, 11));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant3.calculate(12345, 1000, 1000));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant3.calculate(1000, 12345, 1000));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant3.calculate(1000, 1000, 12345));
    }
    ...
    /*
        ...
        2. Boundary value analysis:
            ...
            Frontiere pentru a, b si c: 9, 10, 10000, 10001, 5, 123, 12345

     */

    @Test
    void boundaries() {
        assertArrayEquals(new String[]{messageNotValid}, MainMutant3.calculate(9, 1000, 1000));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant3.calculate(1000, 9, 1000));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant3.calculate(1000, 1000, 9));

        assertArrayEquals(
                new String[]{String.format(messageNotCoPrime, 10, 1000), String.format(messageSumIsNotGreater, 10, 1000, 1000)},
                MainMutant3.calculate(10, 1000, 1000));
        assertArrayEquals(
                new String[]{String.format(messageNotCoPrime, 1000, 10), String.format(messageSumIsNotGreater, 1000, 10, 1000)},
                MainMutant3.calculate(1000, 10, 1000));
        assertArrayEquals(
                new String[]{String.format(messageNotCoPrime, 1000, 1000), String.format(messageSumIsNotGreater, 1000, 1000, 10)},
                MainMutant3.calculate(1000, 1000, 10));
    }
