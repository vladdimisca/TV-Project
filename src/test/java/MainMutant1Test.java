...
class MainMutant1Test {
    ...
    @Test
    void equivalence() {
        assertArrayEquals(new String[]{messageNotValid}, MainMutant1.calculate(0, 1000, 1000));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant1.calculate(1000, 0, 1000));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant1.calculate(1000, 1000, 0));
        assertArrayEquals(
                new String[]{String.format(messageCoPrime, 15, 17), String.format(messageSumIsGreater, 15, 17, 11)},
                MainMutant1.calculate(15, 17, 11));
        assertArrayEquals(
                new String[]{String.format(messageNotCoPrime, 14, 18), String.format(messageSumIsGreater, 14, 18, 11)},
                MainMutant1.calculate(14, 18, 11));
        assertArrayEquals(
                new String[]{String.format(messageCoPrime, 12, 11), String.format(messageSumIsNotGreater, 12, 11, 11)},
                MainMutant1.calculate(12, 11, 11));
        assertArrayEquals(
                new String[]{String.format(messageNotCoPrime, 14, 12), String.format(messageSumIsNotGreater, 14, 12, 11)},
                MainMutant1.calculate(14, 12, 11));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant1.calculate(12345, 1000, 1000));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant1.calculate(1000, 12345, 1000));
        assertArrayEquals(new String[]{messageNotValid}, MainMutant1.calculate(1000, 1000, 12345));
    }
