...
public class MainMutant1 {
    ...
    */
    ...
    static String[] calculate(int a, int b, int c) {
        ...
        String[] responses = new String[] {"xyz", "abc"}; // a fost inlocuita declararea unui array de 2 elemente cu declarare + initializare
        ...
        if (computeSumOfDigits(a) + computeSumOfDigits(b) > c) {
